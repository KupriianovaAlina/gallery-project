import {ERROR_MESSAGES, INITIAL_FORM_DATA, NAVIGATION_PATH_MAIN_PAGE, NAVIGATION_PATH_SIGN_UP_PAGE} from "./constants";
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
              ...
              <a href="#" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 ml-3"
                 onClick={() => navigate(NAVIGATION_PATH_SIGN_UP_PAGE)}>
                  Sign Up
              </a>
            </p>
          </div>
